...
function handleGlobeTransition(section) {
    if (section === 1) {
        ...
        vid_motion.style.opacity = '1'; // Start with opacity 0
        // vid_motion.style.animation = 'vidMotionAnimation22 5s ease forwards'; // Apply the animation
        ...
        vid_motion.style.transition = 'transform 1s ease, right 7s ease-in-out, bottom 10s ease, opacity 1s ease';
